...
if not exist "sapi_env\Scripts\activate.bat" (
    echo [ERROR] Virtual environment not found at sapi_env\Scripts\activate.bat
    pause
    exit /b 1
)
call "sapi_env\Scripts\activate.bat"

:: Navigate to Django project folder
cd /d "I:\Projects\BUMDes\projects_bumdes"
